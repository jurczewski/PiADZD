...
avg_month = months2.groupby(months["FL_DATE"].dt.month).mean()
...
plt.title('wpływ roku 2020 na średnią liczbę lotów')
plt.bar(avg_month_no2020.index-0.3, avg_month_no2020.FLIGHTS, width=0.3)
plt.legend(labels=['po 2020', 'przed 2020'])
plt.savefig("plots/months_avg_2020.png",fromat="png")
plt.show()
plt.clf()
